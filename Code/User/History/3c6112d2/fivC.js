...
// - We are going to write a HTTP server using NodeJS and a library called Express. Express is an external library.
// ** Creating a HTTP server using Express ** => done in the next file named "HTTP-server"




// O: How to expose it over the internet like chatgpt.com
// Q: What does parsing a URL mean: 
// - Parsing means first figuring out what the URL maps to. THen removing the preceeding "https://" and follwing "/2001" etx and just getting the base text. like "chat.openai.com"