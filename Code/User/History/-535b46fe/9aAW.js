...
// MIDDLEWARE: 
app.use(bodyParser.json()) // when a body has JSON, it will extarct it and put it in req.body
...
app.post('/convo', function (req, res){
  ...
  console.log(data);  // if we run this we get undefined.
